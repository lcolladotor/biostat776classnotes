...
## https://github.com/lcolladotor/jhustatcomputing/blob/main/posts/13-ggplot2-plotting-system-part-2/index.R

## ---------------------------------------------------------------------------------------------------
#| message: false
library("tidyverse")
library("here")
maacs <- read_csv(here("data", "bmi_pm25_no2_sim.csv"), col_types = "nnci")
maacs
...
## ---------------------------------------------------------------------------------------------------
#| echo: false
#| fig-cap: "Palmer penguins bill depth and length"
#| out-width: '60%'
#| fig-align: 'center'
knitr::include_graphics(
