## -----------------------------------------------------------------------------------------------------------------
#| eval: false
#| label: install chattr and demonstrate it
...
## -----------------------------------------------------------------------------------------------------------------
x <- 1
# x <<- 2 # global assignment operator
print(x)
x
msg <- "hello"
...
c(1, TRUE, 2)
obs <- c(TRUE, FALSE, TRUE, FALSE, FALSE)
mean(obs)
as.integer(obs)
mean(as.integer(obs))
...
## -----------------------------------------------------------------------------------------------------------------
x <- factor(c("yes", "yes", "no", "yes", "no", NA)) 
x
table(x)
table(x, useNA = "ifany") 
